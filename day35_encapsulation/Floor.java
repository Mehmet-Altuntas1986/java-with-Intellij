...
public class Floor {
	...
	double length,width;   //global  (class in icinde fakat classin icindeki  methodlarin disinda olunca)  //global olunca sanirim diger methodlarda bunu kullanabiliyor
