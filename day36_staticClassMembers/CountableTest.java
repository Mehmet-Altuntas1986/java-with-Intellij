...
public class CountableTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(Countable.instanceCount);  //class name (countable) ile de bu variable in degerine ulasilabilir, cunku variable is static yani  belongs to class
