...
public class Product implements Comparable<Product> {
	...
	public Product(String name, double price) {     //right click ile constructor , getter and setters olusturuldu.
		super();
		this.name = name;
		this.price = price;
	}
	...
	public int compareTo(Product anotherProduct) {
		...
		if(this.price > anotherProduct.price) {  //this belongs to object
			return 1;
