...
public class Salary {
	...
	public String toString() { // allows us to print salary object
		return "Salary {rate= $" + rate + ", weeklyHour=" + weeklyHour + ", taxRate=" + taxRate + ", salary=$"
				+ salary() + ", total tax=$" + totalTax() + ", salary after tax=$" + salaryAfterTax() + "}";
	}

}

/*
 * Salary: attributes rate, weeklyHour, taxRate
 * 
 * actions: setInfo(), salary(), totalTax(), salaryAfterTax(), toString()
 */
